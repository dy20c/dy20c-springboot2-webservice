...
public class PostsRepositoryTest {
    ...
    public void 게시글저장_불러오기(){
        ...
        postsRepository.save(Posts.builder() // (2) postsRepository.save
            .title(title)
            .content(content)
            .author("mindofdream@icloud.com")
            .build());

        // when
        List<Posts> postsList = postsRepository.findAll(); // (3) postsRepository.findAll
...
*      - 보통은 배포 전 전체 테스트를 수행할 때 테스트간 데이터 침범을 막기위해 사용합니다.
